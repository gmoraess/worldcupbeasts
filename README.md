...
- **Etapa 3 — HUD broadcast + juice + arte** 🔄 — HUD de transmissão (placar com retratos + relógio + posse), **controle de velocidade** (Lento/Normal/Rápido), **fúria + supers + cut-ins** (barra carrega por eventos → super-chute/super-defesa com cut-in deslizando do canto), e retratos/ícones nas telas (PNGs temporários). Falta: áudio e arte definitiva.
